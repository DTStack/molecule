...
function SubMenu(props) {
    var className = props.className, name = props.name, render = props.render, _a = props.data, data = _a === void 0 ? [] : _a, _b = props.mode, mode = _b === void 0 ? MenuMode.Vertical : _b, icon = props.icon, children = props.children, custom = __rest(props, ["className", "name", "render", "data", "mode", "icon", "children"]);
    ...
    var subMenuContent = data.length > 0 ? (React.createElement(menu_1.Menu, { className: cNames, style: { visibility: 'hidden' }, data: data })) : (React.createElement(menu_1.Menu, { className: cNames, style: { visibility: 'hidden' } }, children));
    return (React.createElement("li", __assign({ className: base_1.defaultMenuItemClassName }, events, custom),
