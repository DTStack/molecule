...
var Collapse = function (props) {
    ...
    var className = props.className, _b = props.data, data = _b === void 0 ? [] : _b, onCollapseChange = props.onCollapseChange, onCollapseToolbar = props.onCollapseToolbar, restProps = __rest(props, ["className", "data", "onCollapseChange", "onCollapseToolbar"]);
    var onChangeCallback = function (key) {
        onCollapseChange === null || onCollapseChange === void 0 ? void 0 : onCollapseChange(key);
        setState(function (state) { return (__assign(__assign({}, state), { activePanelKeys: key })); });
    };
    var onClick = function (e, item) {
        e.stopPropagation();
        onCollapseToolbar === null || onCollapseToolbar === void 0 ? void 0 : onCollapseToolbar(item);
    ...
    return (React.createElement("div", { className: className_1.classNames(defaultCollapseClassName, className) },
        React.createElement(rc_collapse_1.default, __assign({}, restProps, { onChange: function (activeKeys) {
            ...
            } }), data.map(function (panel) { return (React.createElement(rc_collapse_1.Panel, { key: panel.id, header: panel.name, className: panel.className, extra: (activePanelKeys === null || activePanelKeys === void 0 ? void 0 : activePanelKeys.includes(panel.id)) && (React.createElement(toolbar_1.default, { key: panel.id, data: panel.toolbar, onClick: onClick })) }, render(panel.renderPanel))); }))));
};
