...
var TreeView = function (props) {
    var className = props.className, _a = props.data, data = _a === void 0 ? [] : _a, draggable = props.draggable, onDropTree = props.onDropTree, onRightClick = props.onRightClick, renderTitle = props.renderTitle, // custom title
    restProps = __rest(props, ["className", "data", "draggable", "onDropTree", "onRightClick", "renderTitle"]);
    ...
    var renderTreeNodes = function (data) { return data === null || data === void 0 ? void 0 : data.map(function (item, index) {
        var isEditable = item.isEditable, id = item.id, icon = item.icon, children = item.children;
        return (
        /**
         ...
         */
        React.createElement(rc_tree_1.TreeNode, { "data-id": "mo_treeNode_" + id, "data-index": index, data: item, title: renderTitle === null || renderTitle === void 0 ? void 0 : renderTitle(item, index), key: "" + id, icon: isEditable ? '' : React.createElement(icon_1.Icon, { type: icon }) }, children && renderTreeNodes(children)));
    }); };
    return (React.createElement("div", { className: className_1.classNames(className_1.prefixClaName('tree'), className) },
        React.createElement("div", { className: className_1.prefixClaName('tree', 'sidebar') },
            React.createElement(rc_tree_1.default, __assign({ prefixCls: "rc-tree", draggable: draggable, onDrop: onDrop, switcherIcon: React.createElement(icon_1.Icon, { type: "chevron-right" }), onSelect: function (selectedKeys, e) {
                    var _a;
                    (_a = props.onSelectFile) === null || _a === void 0 ? void 0 : _a.call(props, e.node.data);
                }, onRightClick: onRightClick }, restProps), renderTreeNodes(data)))));
};
exports.default = react_1.memo(TreeView);
