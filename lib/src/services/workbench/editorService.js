...
var EditorService = /** @class */ (function (_super) {
    ...
    Object.defineProperty(EditorService.prototype, "editorInstance", {
        get: function () {
            var _a;
    ...
    EditorService.prototype.closeOthers = function (tab, groupId) {
        var _a = this.state.groups, groups = _a === void 0 ? [] : _a;
        var nextGroups = __spread(groups);
        var groupIndex = this.getGroupIndexById(groupId);
        var tabId = tab.id;
        ...
        var updateTabs = nextTabData.filter(function (tab) { return tab.id === tabId; });
        this.updateGroup(groupId, {
            data: updateTabs,
        });
        this.setActive(groupId, tabId);
    };
    EditorService.prototype.closeToRight = function (tab, groupId) {
        var _a = this.state.groups, groups = _a === void 0 ? [] : _a;
        var nextGroups = __spread(groups);
        var groupIndex = this.getGroupIndexById(groupId);
        var tabId = tab.id;
        ...
        var nextGroup = nextGroups[groupIndex];
        var nextTabData = nextGroup.data;
        var tabIndex = nextTabData.findIndex(helper_1.searchById(tabId));
        if (tabIndex <= -1)
            return;
    ...
    EditorService.prototype.closeToLeft = function (tab, groupId) {
        var _a = this.state.groups, groups = _a === void 0 ? [] : _a;
        var nextGroups = __spread(groups);
        var groupIndex = this.getGroupIndexById(groupId);
        var tabId = tab.id;
    ...
    EditorService.prototype.getGroupById = function (groupId) {
        var groups = this.state.groups;
        return groups.find(function (group) { return group.id === groupId; });
    };
    ...
    EditorService.prototype.updateCurrentGroup = function (currentValues) {
