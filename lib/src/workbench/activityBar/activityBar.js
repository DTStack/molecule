...
function ActivityBar(props) {
    var _a = props.data, data = _a === void 0 ? [] : _a, selected = props.selected, onClick = props.onClick, onSelect = props.onSelect, onContextMenuClick = props.onContextMenuClick;
    ...
    var renderItems = function (item, index) {
        return (React.createElement(activityBarItem_1.default, __assign({ key: item.id }, item, { onContextMenuClick: onContextMenuClick, onClick: onClickBar, "data-index": index, checked: selected === item.id })));
    };
