...
function Editor(props) {
    var _a = props.groups, groups = _a === void 0 ? [] : _a, current = props.current, onClickContextMenu = props.onClickContextMenu, onCloseTab = props.onCloseTab, onMoveTab = props.onMoveTab, onSelectTab = props.onSelectTab, _b = props.groupSplitPos, groupSplitPos = _b === void 0 ? [] : _b, onChangeEditorProps = props.onChangeEditorProps, onSplitEditorRight = props.onSplitEditorRight, onUpdateEditorIns = props.onUpdateEditorIns, onPaneSizeChange = props.onPaneSizeChange;
