...
function StatusItem(props) {
    var className = props.className, onClick = props.onClick, name = props.name, data = props.data, render = props.render, extra = __rest(props, ["className", "onClick", "name", "data", "render"]);
    ...
    return (React.createElement("div", __assign({ className: clsName }, extra),
        React.createElement("a", __assign({ tabIndex: -1, title: name }, events), render ? render(props) : name)));
}
