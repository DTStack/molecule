...
export default class QuickToggleSidebarAction extends BaseAction {
    static readonly ID = 'workbench.action.sidebar';

    constructor(private molecule: IMoleculeContext) {
        super({
            id: QuickToggleSidebarAction.ID,
            label: molecule.locale.localize('menu.showSideBar.label', 'Toggle Side Bar Visibility'),
            title: molecule.locale.localize('menu.showSideBar.label', 'Toggle Side Bar Visibility'),
